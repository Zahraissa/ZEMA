...
const RightObligation = () => {

    const [aboutData] = useState<AboutData>({
        Rights:[
            {
                description : "Declaration of business or services."
            },
            {
                description : "Inspections to be conducted."
            },
            {
                description : "Rights and obligation of license."
            },
            {
                description : "Services rendered."
            },
            {
                description : "Protection of health, safety and environment (If applicable)."
            },
        ],
        Obligations:[
            {
                description : "Failure to comply with the terms and conditions provided."
            },
            {
                description : "Commits any act which would be grounds to deny the license."
            },
            {
                description : "Commits  an illegal act."
            },
            {
                description : "Allow any of its agents or employees to commit an illegal act."
            },
            {
                description : "Refuses to allow an inspection."
            },
            {
                description : "Commits any other act prohibited by their legislations."
            },
        ],
    });
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-100 p-6 sticky top-8 hover:shadow-xl transition-shadow">
                                ...
                                <nav className="space-y-1">
                                    ...
                                    <a href="/right-obligation" className="block text-gray-800 font-bold bg-green-100 py-2 px-3 rounded-lg border-l-4 border-green-600">
                        ...
                        <div className="lg:col-span-3">
                            <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-100 overflow-hidden hover:shadow-xl transition-shadow">
                                ...
                                <div className="p-8">
                                    ...
                                    <div className="mb-8">
                                        <h3 className="text-2xl font-bold text-gray-500 mb-6">Rights of License</h3>
                                        <h5 className="font-middle text-gray-500 mb-6">The License granted to the applicant shall have the following general conditions.</h5>
                                    ...
                                    <div className="mb-8">
                                        <h3 className="text-2xl font-bold text-gray-500 mb-4">Obligations of License</h3>

                                        <div className="grid sm:grid-cols-2 gap-6">
                                            {aboutData.Obligations.map((value, index) => {
                                                return (
...
export default RightObligation;
