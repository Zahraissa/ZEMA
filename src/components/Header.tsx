  ...
  return (
    <header className="bg-[#2b8a57] shadow-elegant">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('header-banner.webp')",
      ...
      >
        ...
        <div className="flex flex-col items-center text-center notranslate mx-4 flex-1 max-w-4xl">
          ...
          <p className="text-white text-xl lg:text-2xl xl:text-2xl font-serif font-bold mt-2 px-4 break-words whitespace-normal">
