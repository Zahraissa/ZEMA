          ...
          >
              {services.map((service) => (
                  <SwiperSlide key={service.id}>
                      <Link
                          to={`/services/${service.id}`}
                          className="block relative rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300"
                      >
                          {/* Full Image */}
                          <img
                              src={getImageUrl(service.image_path)}
                          ...
                          <div className="absolute bottom-0 w-full p-4 sm:p-5 bg-gradient-to-t from-white/90 via-white/40 to-transparent rounded-b-xl">
