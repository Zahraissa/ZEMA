...
const AddSampuli: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append('category', 'Sample Templates'); // Default category
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Ongeza sampuli mpya kwenye mfumo</p>
              </div>
            </div>
