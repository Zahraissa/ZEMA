  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Swal.fire({
        icon: 'success',
        title: 'Menu Updated',
        text: 'Your menu has been successfully updated.',
      })
      navigate("/cms/menu")
    } catch (error) {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Update your dynamic navigation menu and dropdown items
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Manage groups that will appear as dropdown menus
                </CardDescription>
              </div>
        ...
        <div className="flex justify-end">
          <Button type="submit" disabled={loading} className="bg-gradient-to-r from-primary to-accent">
            ...
            {loading ? 'Updating Menu...' : 'Update Menu'}
          </Button>
        </div>
      </form>
    </div>
